"""
(Not important for the assignments) \n
...
class Display(abc.ABC):
    ...
    def closed(self) -> bool:
        """
        Whether this display has been closed, indicating that the game should be quit as quickly as possible.
        """
        return False
...
class GraphicalDisplay(Display):
    ...
    def get_keypress(self) -> str:
        ...
        Get input from the user of the display.
        """
        while self._current_keypress is None and not self.closed:  # wait for user input
            self.canvas.update()
